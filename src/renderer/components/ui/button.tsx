...
const buttonVariants = cva(
  "ui-pressable inline-flex appearance-none items-center justify-center whitespace-nowrap rounded-md text-body-sm font-medium transition-[background-color,border-color,color,box-shadow,transform,opacity] ui-motion-fast outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 disabled:pointer-events-none disabled:opacity-100 disabled:[-webkit-text-fill-color:currentColor] [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "border border-border bg-surface-2 text-secondary-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] hover:bg-surface-3 active:bg-surface-3 active:text-secondary-foreground active:border-border disabled:border-border/75 disabled:bg-surface-3/80 disabled:text-disabled disabled:shadow-none",
        ghost:
