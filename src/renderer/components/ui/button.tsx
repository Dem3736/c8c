...
const buttonVariants = cva(
  "ui-pressable inline-flex appearance-none items-center justify-center whitespace-nowrap rounded-md text-body-sm font-medium transition-[background-color,border-color,color,box-shadow,transform,opacity] ui-motion-fast outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 [-webkit-text-fill-color:currentColor] disabled:pointer-events-none disabled:opacity-100 disabled:[-webkit-text-fill-color:currentColor] [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "border border-border bg-surface-1 text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.86),0_0_0_1px_hsl(var(--hairline)/0.2)] hover:bg-surface-2 hover:border-hairline active:bg-surface-2 active:text-foreground active:border-hairline disabled:border-border/80 disabled:bg-surface-2/80 disabled:text-foreground/75 disabled:shadow-none",
        secondary:
          "border border-border bg-surface-2 text-secondary-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] hover:bg-surface-3 active:bg-surface-3 active:text-secondary-foreground active:border-border disabled:border-border/75 disabled:bg-surface-3/80 disabled:text-foreground/75 disabled:shadow-none",
        ghost:
          "border border-transparent text-muted-foreground hover:bg-surface-3 hover:text-foreground hover:border-hairline/70 active:bg-surface-3 active:text-foreground active:border-hairline/70 active:scale-[0.99] disabled:text-foreground/65 disabled:bg-transparent disabled:border-transparent",
        link: "text-primary underline-offset-4 hover:underline active:text-primary disabled:text-foreground/65 disabled:no-underline",
      },
      size: {
